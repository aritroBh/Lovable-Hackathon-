...
Hackathon (laptop-first + Skills Hub): see [`docs/HACKATHON_DEMO_RUNBOOK.md`](docs/HACKATHON_DEMO_RUNBOOK.md). Mac→Hub dex sync needs `SKILLS_HUB_URL` and matching `SPECTER_USER_ID` in `.env` — see [`docs/HACKATHON_INTEGRATION.md`](docs/HACKATHON_INTEGRATION.md).
