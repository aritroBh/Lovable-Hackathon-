...
Open **Cmd+Shift+M → Docs** in the app, or browse [`docs/README.md`](docs/README.md).

| Document | Contents |
| --- | --- |
| [`docs/README.md`](docs/README.md) | Master index |
| [`docs/COMPUTER_USE.md`](docs/COMPUTER_USE.md) | Target resolution, coordinates, click pipeline |
| [`docs/TESTING.md`](docs/TESTING.md) | Automated test commands |
| [`DEMO_RUNBOOK.md`](DEMO_RUNBOOK.md) | Verified demo script, hotkeys, troubleshooting |
| [`docs/HACKATHON_INTEGRATION.md`](docs/HACKATHON_INTEGRATION.md) | Tavus × Lovable × Specter integration |
| [`docs/HACKATHON_DEMO_RUNBOOK.md`](docs/HACKATHON_DEMO_RUNBOOK.md) | Laptop-first hackathon demo script |
| [`skills-hub/README.md`](skills-hub/README.md) | Skills Hub — game loop, API, sync, verify |
| [`skills-hub/design/GAME_LOGIC.md`](skills-hub/design/GAME_LOGIC.md) | Specter Mon state machine + adversarial mitigations |
| [`skills-hub/SUBMIT.md`](skills-hub/SUBMIT.md) | Submission checklist (hack.tavuslabs.org) |
...
| [`docs/CONTRACT.md`](docs/CONTRACT.md) | Brain ↔ overlay IPC contract |
| [`docs/archive/`](docs/archive/) | Superseded plans (historical) |
