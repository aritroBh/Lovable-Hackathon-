...
interface ModeToggleProps {
  ...
  faceMode?: "ghost" | "tavus";
  onFaceModeChange?: (mode: "ghost" | "tavus") => void;
  memoryOpen: boolean;
  onToggleMemory: () => void;
}
...
export const ModeToggle: React.FC<ModeToggleProps> = ({
  ...
  return (
    <div className="specter-mode-row">
      ...
      {onFaceModeChange && (
        <div className="specter-face-toggle" role="tablist" aria-label="Face">
          <button
            type="button"
            role="tab"
            aria-selected={faceMode === "ghost"}
            className={`specter-face-option ${faceMode === "ghost" ? "is-active" : ""}`}
            onClick={() => onFaceModeChange("ghost")}
            title="Ghost mascot"
          >
            <MemoryIcon />
            <span>Ghost</span>
          ...
          <button
            type="button"
            role="tab"
            aria-selected={faceMode === "tavus"}
            className={`specter-face-option ${faceMode === "tavus" ? "is-active" : ""}`}
            onClick={() => onFaceModeChange("tavus")}
            title="Tavus video PAL"
          >
            <FaceIcon />
            <span>Face</span>
          </button>
