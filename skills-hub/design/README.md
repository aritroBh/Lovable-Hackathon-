...
**Shipped React slice:** [`../src/game/GameHub.tsx`](../src/game/GameHub.tsx) — playable GBC overworld + battle / PAL / catch / dex / party. [`JourneyContext.tsx`](../src/JourneyContext.tsx) handles sync (`syncReady`, poll on focus).
